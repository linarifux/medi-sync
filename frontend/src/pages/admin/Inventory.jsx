...
import { 
  ...
  Eye, ShoppingCart, CheckCircle2, Search, Filter, Box, Calendar
} from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto pb-12 w-full px-2 sm:px-0">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        {/* MOBILE VIEW (Hidden on desktop) - Card Layout */}
              ...
              {medicines.length === 0 ? (
                <>
                  ...
                  <div className="text-center">
                    <h3 className="text-base font-bold text-gray-900">No medicines found</h3>
                    <p className="text-gray-500 text-xs mt-1">Get started by adding your first medication.</p>
                  </div>
                  <button onClick={() => setIsAddModalOpen(true)} className="mt-2 text-blue-600 bg-blue-50 px-4 py-2 rounded-lg hover:bg-blue-100 text-sm font-medium transition-colors">
                    Add New Medicine
                  </button>
                </>
              ) : (
